    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[80vh]">
            ...
            <img
                src="/handprayer.png"
                alt="기도하는 이미지"
                className="w-40 h-40 object-contain mb-6 drop-shadow-lg rounded-full border-4 border-yellow-200 bg-white"
            />
            <div className="text-xl md:text-2xl font-bold text-yellow-800 text-center mb-8">
